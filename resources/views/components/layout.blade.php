...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="mx-auto mt-10 max-w-2xl text-slate-700 bg-gradient-to-r from-indigo-100 from-10% via-sky-100 via-30% to-emerald-100 to-90% ">
        ...
        @if (session('success'))
            <div 
                role="alert" 
                class="my-8 p-4 rounded-md border-l-4 border-green-300 bg-green-100 text-green-700 opacity-75"
            >
        ...
        @if (session('error'))
            <div 
                role="alert" 
                class="my-8 p-4 rounded-md border-l-4 border-red-300 bg-red-100 text-red-700 opacity-75"
            >
